...
function DatasetRow({
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-white/40 bg-white/60 backdrop-blur-sm p-3 shadow-sm transition hover:shadow-md">
      <div>
      ...
      <span
        className={`rounded-full px-2.5 py-1 text-[10px] font-bold ${status === "Live" ? "bg-emerald-50/80 text-emerald-700 border border-emerald-100" : "bg-primary/10 text-primary border border-primary/20"}`}
      >
        {status}
      </span>
    </div>
...
function Metric({ label, value, delta }: { label: string; value: string; delta: string }) {
  ...
  return (
    <div className="rounded-xl border border-white/40 bg-white/60 backdrop-blur-sm p-3 shadow-sm transition hover:shadow-md">
